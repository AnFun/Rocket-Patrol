class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add Rocket (p2)
        this.p2Rocket = new Cannon(this, game.config.width / 2, game.config.height - borderUISize - borderPadding, 'cannon');
        // add spaceships (x3)
        ...
        let date = new Date();
        this.timer = date.getTime() + game.settings.gameTimer;
        ...
        this.timeleft = this.add.text(496, borderUISize + borderPadding * 2, Math.round((this.timer - date.getTime()) / 1000), this.scoreConfig);
    ...
    update() {
        ...
        this.timeleft.text = Math.max(Math.round((this.timer - (new Date().getTime())) / 1000),0)+"s";
    }
